...
submitButton1.onclick = () => {
  ...
  if (0 <= numberInput1 >= 19) {
    message1 = 'That was a terrible score';
  } else if (20 <= numberInput1 >= 39) {
    message1 = 'You know some things. Needs improvement';
  } else if (40 <= numberInput1 >= 69) {
    message1 = 'You did a passable job, not bas!';
  } else if (70 <= numberInput1 >= 89) {
    message1 = "That's a great score. You really know your stuff.";
  } else if (90 <= numberInput1 >= 100) {
    message1 = 'What an amazing score!';
  } else if (0 > numberInput1 < 100) {
...
submitButton2.onclick = () => {
  ...
  switch (true) {
    case numberInput2 <= 19:
      message2 = "That's was a terrible score!";
      break;
    case numberInput2 <= 39:
      message2 = 'You know some things. Needs improvements.';
      break;
